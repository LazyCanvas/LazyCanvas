...
Drawable* instance_drawable(char*, double, double, double, double);
/*********************************************************
...
void instance_line(double position_x, double position_y, double second_position_x, double second_position_y, double line_width, char *background, char *name) {
  ...
  Drawable *drawable = instance_drawable(background, position_x, position_y, line_width, 0);
...
Drawable* instance_drawable(char* background, double position_x, double position_y, double line_width, double rotate) {
